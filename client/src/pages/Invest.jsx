...
export default function Invest() {
  ...
  const handleSubmit = (e) => {
    ...
    triggerAlert(
      "Félicitations !",
      "Votre demande d'investissement a été transmise avec succès. Notre équipe d'accompagnement vous contactera sous 24h pour finaliser votre dossier.",
      "success",
    );
    setStep(1);
  };
    ...
    >
      ...
      <section className="max-w-7xl mx-auto px-6 mb-20">
        <div className="text-center max-w-3xl mx-auto">
          <h1
            className={`text-4xl md:text-6xl font-black mb-6 ${isDark ? "text-white" : "text-slate-900"}`}
          >
            Investissez dans le{" "}
            <span className="text-transparent bg-clip-text bg-linear-to-r from-[#D4AF37] via-[#F9E076] to-[#996515]">
              Futur de Kafumbu
            </span>
          </h1>
          <p
            className={`text-lg leading-relaxed ${isDark ? "text-slate-400" : "text-slate-500"}`}
          >
            Participez à la construction d'une infrastructure majeure.
            Choisissez votre niveau d'engagement et rejoignez une aventure
            historique.
          </p>
        </div>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-4 lg:px-6">
        <div
          className={`rounded-xl md:rounded-2xl border transition-all duration-500 overflow-hidden ${
            isDark
        ...
        >
          {/* Progress Header */}
          <div
            className={`px-8 py-6 flex items-center justify-between border-b ${isDark ? "border-white/5 bg-white/5" : "border-slate-100 bg-slate-50/50"}`}
          >
            <div className="flex items-center gap-8">
              {[1, 2, 3].map((num) => (
                <div key={num} className="flex items-center gap-3">
                  ...
                  <span
                    className={`hidden sm:block text-[11px] font-black uppercase tracking-widest ${
          ...
          <div className="p-8 md:p-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
                  {TIERS.map((tier) => (
                    ...
                    >
                      ...
                      />
                      <h3
                        className={`font-black text-sm uppercase tracking-wider mb-1 ${isDark ? "text-white" : "text-slate-900"}`}
                      >
                        {tier.name}
                      </h3>
                      <p className="text-[#D4AF37] font-black text-lg mb-4">
            ...
            {step === 2 && (
              <div className="animate-in fade-in slide-in-from-right-4 duration-500 max-w-2xl mx-auto">
                <h2
                  className={`text-2xl font-black mb-8 text-center ${isDark ? "text-white" : "text-slate-900"}`}
                >
                  Vos informations
                </h2>
                <form className="space-y-6">
                  ...
                  <div className="flex justify-between items-center mt-12 pt-8 border-t border-white/5">
                    <button
                      onClick={prevStep}
                      className="text-slate-500 font-bold text-xs uppercase tracking-widest hover:text-amber-500 transition-colors"
                    >
                      Retour
                    </button>
                    <button
            ...
            {step === 3 && (
              <div className="animate-in fade-in slide-in-from-right-4 duration-500 max-w-2xl mx-auto">
                    ...
                    >
                      <div className="flex items-center gap-4">
                        ...
                        <div className="text-left">
                          <h4
                            className={`font-black text-sm uppercase tracking-wider ${isDark ? "text-white" : "text-slate-900"}`}
                          >
                            {method.name}
                          </h4>
                ...
                <div
                  className={`mt-10 p-6 rounded-2xl border border-dashed flex items-start gap-4 ${isDark ? "bg-white/5 border-white/10" : "bg-slate-50 border-slate-200"}`}
                >
                  <FiShield
                  ...
                  <p className="text-xs text-slate-500 leading-relaxed font-medium italic">
                    Toutes les transactions sont sécurisées et font l'objet d'un
                    audit de transparence financière trimestriel conformément
                    aux lois en vigueur.
                  </p>
                </div>
