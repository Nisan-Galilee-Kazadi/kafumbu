...
const PARTNERS_CAT = [
  {
    name: "Institutions financières internationales",
    type: "Finance & Bailleurs",
  },
  {
    name: "Agences publiques et gouvernements",
    type: "Institutionnel & Régulation",
  },
...
export default function Partenaires() {
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      ...
      setSubmitMessage(
        "✅ Votre demande de partenariat a été envoyée avec succès ! Nous vous contacterons dans les 48 heures.",
      );
      setFormData({
        name: "",
        email: "",
  ...
  return (
    ...
    >
      ...
      <section className="max-w-7xl mx-auto px-6 mb-16 text-center">
        ...
        >
          Le projet mobilise une coalition d'acteurs publics et privés pour
          garantir un impact économique, énergétique et social durable.
        </p>
      </section>
          ...
          {[
            {
              icon: FiUsers,
              title: "Investisseurs",
              text: "Participation au financement long terme et levée de fonds.",
            },
            {
              icon: FiShield,
              title: "Gouvernance",
              text: "Cadre de régulation et crédibilité auprès des institutions.",
            },
            {
              icon: FiTool,
              title: "Expertise",
              text: "Ingénierie de pointe et contrôle qualité des infrastructures.",
            },
            {
              icon: FiGlobe,
              title: "Impact",
              text: "Alignement sur les objectifs de développement durable.",
            },
          ].map((pillar, i) => (
            <div
              key={i}
              className={`p-8 rounded-xl md:rounded-2xl border transition-all duration-500 ${
                isDark
        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-6">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
            <div className="max-w-xl">
              ...
              >
                Catégories de Partenaires Cibles
              </h2>
            ...
            >
              {showForm ? "Masquer le formulaire" : "Demande de partenariat"}{" "}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {PARTNERS_CAT.map((cat, i) => (
              <div
                key={i}
                className={`flex items-center justify-between p-6 rounded-xl md:rounded-lg border transition-all ${
                  isDark
                    ? "bg-[#071426] border-white/10 hover:bg-white/5"
                    : "bg-white border-slate-200 hover:shadow-lg"
                }`}
              >
                <div>
                  <div
                    className={`text-sm font-bold mb-1 ${isDark ? "text-white" : "text-slate-900"}`}
                  >
                    {cat.name}
                  </div>
                ...
                <div
                  className={`w-8 h-8 rounded-full border flex items-center justify-center ${isDark ? "border-white/10" : "border-slate-100"}`}
                >
      ...
      <section className="max-w-5xl mx-auto px-6 py-24 text-center">
        <h2
          className={`text-2xl font-black mb-8 ${isDark ? "text-white" : "text-slate-400 opacity-60"}`}
        >
          Collaborons pour bâtir Kafumbu
        </h2>
      ...
      {showForm && (
        <>
          ...
          <div className="fixed inset-0 flex items-center justify-center p-4 z-50">
            <div
              className={`max-w-2xl w-full max-h-[85vh] overflow-y-auto rounded-2xl border p-8 shadow-2xl transform transition-all duration-300 scale-100 ${
                isDark
            ...
            >
              ...
              <div className="flex items-center justify-between mb-6">
                <h3
                  className={`text-2xl font-black ${isDark ? "text-slate-900" : "text-slate-900"}`}
                >
              ...
              {submitMessage && (
                <div
                  className={`p-4 rounded-xl mb-6 ${submitMessage.includes("succès") ? "bg-emerald-500/10 text-emerald-500 border border-emerald-500/20" : "bg-red-500/10 text-red-500 border border-red-500/20"}`}
                >
              ...
              >
                ...
                {formStep === 1 && (
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      <label
                        className={`block text-sm font-bold mb-2 ${isDark ? "text-slate-900" : "text-slate-900"}`}
                      >
