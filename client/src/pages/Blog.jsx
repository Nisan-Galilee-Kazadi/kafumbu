...
const ARTICLES = [
  {
    date: "2025-04-15",
    tag: "Communiqué",
    title: "Lancement officiel du projet Kafumbu Melys City",
    excerpt:
      "Le projet de construction de la cité moderne de Kafumbu est officiellement lancé avec la signature des premiers accords de partenariat stratégique.",
    image:
  ...
  },
  {
    ...
    excerpt:
      "Les études géotechniques et hydrauliques sont en cours pour valider le site d'implantation du barrage de 15 MW.",
    image:
  ...
  },
  {
    ...
    excerpt:
      "Plusieurs fonds d'investissement internationaux ont exprimé leur intérêt pour le projet lors du Forum Économique d'Afrique centrale.",
    image:
      "https://images.unsplash.com/photo-1454165833762-026522f22143?auto=format&fit=crop&q=80&w=800",
  },
];
    ...
    >
      ...
      <section className="max-w-7xl mx-auto px-4 lg:px-6 mb-16">
        <div className="max-w-3xl">
          ...
          >
            Suivez en temps réel l'évolution du projet, les étapes de
            construction et les annonces institutionnelles.
          </p>
        </div>
      </section>
            ...
            <article
              ...
              className={`group flex flex-col rounded-xl md:rounded-2xl border transition-all duration-500 overflow-hidden ${
                isDark
                  ...
                  : "bg-white border-slate-200 hover:shadow-2xl hover:shadow-slate-200"
              }`}
            >
              ...
              <div className="p-8 flex-1 flex flex-col">
                <div className="flex items-center gap-4 mb-4 text-[11px] font-bold text-slate-500 uppercase tracking-widest">
                  ...
                  <div className="flex items-center gap-1.5">
                    <FiClock className="text-emerald-500" />4 min
                  </div>
                </div>

                <h2
                  className={`text-xl font-black mb-4 leading-snug group-hover:text-emerald-500 transition-colors ${isDark ? "text-white" : "text-slate-900"}`}
                >
                  {article.title}
                </h2>

                <p
                  className={`text-sm leading-relaxed mb-8 flex-1 ${isDark ? "text-slate-400" : "text-slate-500"}`}
                >
                  {article.excerpt}
                </p>
      ...
      <section className="max-w-7xl mx-auto px-4 lg:px-6 mt-24">
        <div
          className={`p-8 md:p-12 rounded-xl md:rounded-2xl border flex flex-col md:flex-row items-center justify-between gap-8 md:gap-12 ${
            isDark
        ...
        >
          <div className="max-w-md text-center md:text-left">
            ...
            <p
              className={`text-sm font-medium leading-relaxed ${isDark ? "text-slate-400" : "text-slate-500"}`}
            >
              Inscrivez-vous à notre lettre d'information pour recevoir les
              rapports d'avancement mensuels et les opportunités
              d'investissement.
            </p>
          </div>
